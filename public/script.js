...
// login div that will be removed and replaced within topContainerDiv when user logs in 
  ...
  dealBtn.addEventListener('click', () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        resultDiv.textContent = `${response.data.result}<br>player 1: ${response.data.score.player1}<br>player 2: ${response.data.score.player2}`;
